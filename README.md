...
## 2026/2/22 更新
更新内容为：
1. 加入“一键修复”功能，可以ai自动查找一些较为明显的错误，包括人名错误（这个基本百分百可以发现），错别字，吃书（包括但不限于死人复活，人设崩塌，设定突变等）。该功能目前尚不成熟，在考虑进一步改进
2. 更新了第二篇小说————灵雪峰的冲师逆徒小故事

## 2026/2/24 更新
更新内容为：
1. 加入“文段微调”功能，可以按照使用者的设定修改不满意的文段
2. 加入“一键生成卷”功能，现在可以不止一键生成全书了
